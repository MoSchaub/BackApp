...
public struct Recipe: Hashable, Codable, Identifiable{
    ...
    public var notSubsteps: [Step] {
        ...
        return steps.filter { !allSubsteps.contains($0) }
    }
    ...
    static public var complexExample: Recipe {
        let sub = Step(name: "Sauerteig", ingredients: [Ingredient(name: "Mehl", amount: 200), Ingredient(name: "Wasser", amount: 100, isBulkLiquid: true)], themperature: 30)
        var step = Step(name: "Hauptteig", time: 1800, ingredients: [Ingredient(name: "Mehl", amount: 200), Ingredient(name: "Wasser", amount: 150, isBulkLiquid: true), Ingredient(name: "Salz", amount: 20)], themperature: 26)
