...
let package = Package(
    name: "BakingRecipeItems",
    products: [
        // Products define the executables and libraries a package produces, and make them visible to other packages.
        .library(
            name: "BakingRecipeItems",
            targets: ["BakingRecipeItems"]),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .target(
            name: "BakingRecipeItems",
            dependencies: ["BakingRecipeFoundation", "BackAppCore"]),
        .testTarget(
            name: "BakingRecipeItemsTests",
            dependencies: ["BakingRecipeItems"]),
    ]
)
