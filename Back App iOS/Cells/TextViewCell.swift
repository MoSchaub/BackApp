...
public class TextViewCell: CustomCell, UITextViewDelegate {
    ...
    private func setupTextView() {
        ...
        // constraints
        textView.fillSuperview(padding: UIEdgeInsets(top: 8, left: 16, bottom: 8, right: 16))
        ...
        //tint color
        self.textView.tintColor = .primaryCellTextColor
        
        //link color
        textView.linkTextAttributes = [.foregroundColor: UIColor.baTintBackgroundColor ?? UIColor.systemRed]
